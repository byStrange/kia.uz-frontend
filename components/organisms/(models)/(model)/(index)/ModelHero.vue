  ...
  <div class="h-screen overflow-hidden bg-primary">
    <UISafeAreaView :extra="52">
      ...
      <picture class="h-full w-full" data-label="Main Hero image">
        <source :srcset="src('141e96f9-a90b-41e2-947c-1b3f6b9712f6')" media="(min-width: 1024px)" />

        <source :srcset="src('48b7e2b2-dcf3-40c1-912a-83bef358396c')" media="(min-width: 768px)" />
        <img :src="src('7697fb74-fadd-4192-8a5e-5f0491567ff6')" class="w-full object-cover 2xl:h-full md:h-[73%]" />
      </picture>
      <div data-label="Hero bottom"
        ...
        <div class="flex w-full">
          <div class="w-full md:px-0 2xl:grid 2xl:grid-cols-12 2xl:gap-10">
            <div class="space-y-2.5 text-white md:space-y-2 2xl:col-span-3">
              ...
              <h1 class="mt-1 text-2xl font-semibold md:mt-2 md:text-4xl 2xl:mt-4 2xl:text-7xl">
                Carnival
              </h1>
