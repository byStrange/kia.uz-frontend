...
const pageAnimations = {
  ...
  default() {
    ...
    gsap.fromTo($el.querySelectorAll('.double-tabs_left > *:not(div)'), {
      autoAlpha: 0,
      y: -30,
    }, {
      autoAlpha: 1,
    ...
    gsap.from($el.querySelectorAll('.double-tabs__list > *'), {
      x: -30,
      autoAlpha: 0,
      duration: 1,
      stagger: 0.2,
...
<template>
  <MoleculeSection ref="section" :section-title="section.title" :subtitle="section.subtitle"
    ...
    <template #title="{ sectionTitle, sectionTitleClass, subtitleClass, subtitle }">
      <div class="container double-tabs_left" :class="{
        ...
        <div v-if="section.meta && section.meta.tabs"
          ...
          <div>
            <ul class="space-y-3.5 text-base ml-3.5 double-tabs__list">
      ...
      <div :class="{
        'mt-10 col-start-7 col-span-6 2xl:mt-0 double-tabs_right': true,
        ltr: section.direction === 'left',
        ...
        <div v-if="section.meta.tabs">
          <MoleculeTabsContainer ref="tabsRef" :is-header-full="true" :is-header-center="false"
            ...
            <template #1="{ tab }">
              <div
                class="grid grid-cols-3 md:gap-2.5 2xl:flex 2xl:flex-col 2xl:divide-y divide-protection 2xl:gap-0 double-tabs__list">
            ...
            <template #2="{ tab }">
              <div
                class="grid grid-cols-3 md:gap-2.5 2xl:flex 2xl:flex-col 2xl:divide-y divide-protection 2xl:gap-0 double-tabs_right__list">
                <div v-for="(item, index) in tab.items" :key="item.label"
                  class="space-y-2 2xl:flex justify-between items-center"
                  :class="index === 0 ? '2xl:pb-10' : '2xl:py-10'">
                  <p class="text-primary text-lg font-semibold">
