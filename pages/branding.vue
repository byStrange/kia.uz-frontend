  ...
  <div>
    ...
    <div class="pt-[--padding-top]" :style="{ '--padding-top': paddingTop }">
      <div class="relative flex items-center justify-center">
        <img
:src="src('629506cf-36e9-4a27-baa9-e918f57dc4c2')" alt="${0}"
        ...
        <MoleculeSection section-title="Любое творчество начинается с движения" subtitle="МАНИФЕСТ">
          <template #title="{ sectionTitle, subtitle }">
            <div class="space-y-2.5">
              ...
              <h1 class="text-lg font-semibold text-white md:text-2xl 2xl:text-3xl">
                {{ sectionTitle }}
              </h1>
            </div>
          </template>
...
class="text-white space-y-12 py-12 md:py-15 2xl:py-1h md:space-y-15 2xl:space-y-16" :style="{
          ...
          <div class="space-y-12 md:space-y-20 w-full 2xl:space-y-1h">
            <div class="px-3.5 md:px-0">
              <UIMainLogoWhite ref="logo" class="w-full md:h-1.5h 2xl:h-[260px] 2xl:w-[--logo-width-lg] 2xl:mx-auto" />
            </div>
...
:src="src('f997d80d-49c8-4775-8ae8-2fcea5c99917')"
      ...
      <MoleculeSection section-title="Единство противоположностей" subtitle="ФИЛОСОФИЯ">
        ...
        <div class="relative container mt-10 md:mt-15 2xl:mt-16">
          <img :src="src('62bdb5d8-6ca9-4c99-8d1d-c86a254fd01a')" class="relative z-10" />
          <div class="absolute w-full h-[155px] bg-white left-0 -bottom-12 md:-bottom-15 md:h-[245px]"></div>
        </div>
      </MoleculeSection>
        ...
        <MoleculeSection section-title="Движение вдохновляет на идеи" subtitle="ВДОХНОВЕНИЕ" class="pt-0">
          <template #title="{ sectionTitle, subtitle }">
            <div class="space-y-2.5">
              ...
              <h1 class="text-lg font-semibold text-primary md:text-2xl 2xl:text-3xl">
                {{ sectionTitle }}
              </h1>
            </div>
          </template>
      ...
      <div class="bg-white relative">
        <img
:src="src('ae7dcd8f-2b2c-4b75-b0c6-6c5527e80b58')" alt="${0}"
          class="w-full object-cover max-h-[951px] max-w-[1440px] mx-auto" />
        <div
...
section-title="Креативное мышление, инновации и прогресс — наш жизненный менталитет"
      ...
      <img
:src="src('a62a2ac6-fcd1-4954-8450-cb6178a7c0a3', { quality: 'lightest' })
        " class="w-full object-cover max-h-[951px] max-w-[1440px] mx-auto" />
...
v-for="i in 4" :key="i"
            ...
            <div>
              <div>
                <img :src="src('c0cda4b4-ca9f-4509-a9ec-acec3c9a886b')" alt="" />
              </div>
...
:src="src('57407d62-cc4a-4da7-a822-d401c3faf773')"
          class="w-full object-cover max-h-[951px] max-w-[1440px] mx-auto" alt="" />
        <div
