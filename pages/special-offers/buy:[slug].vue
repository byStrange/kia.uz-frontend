...
<template>
  <div>
    <div
      ...
      <picture>
        <source media="(min-width: 1600px)" :srcset="src(
          ...
          " />
        <source :srcset="src('d3ca786f-29fa-45ac-b5de-ef5da8f64557', { preview: '1440x600' })
          " media="(min-width: 1440px)" />
        <source :srcset="src('16c972c6-01c4-4aa4-a695-ec1552e6303d', { preview: '768x420' })
          " media="(min-width: 768px)" />
        <img class="w-full absolute top-0 left-0 h-2/3 object-cover md:h-auto" :src="src('a9a133a8-6bb2-4862-b3e4-d0053e85fa44', { preview: '375x490' })
          " />
      </picture>
    ...
    <UIContainer>
      <div class="pt-10 pb-12.5 space-y-1 2xl:max-w-[1060px] 2xl:pt-20 2xl:pb-10 2xl:mx-auto 2xl:space-y-7.5">
      ...
      <div>
        <DataTable :value="details" striped-rows :style="{ '--container-width': bounding.width.value + 'px' }">
          <Column v-for="field in fields" :key="field.field" :field="field.field" :header="field.label"
      ...
      <div class="py-10 space-y-7.5 2xl:max-w-[1060px] 2xl:mx-auto">
        <div class="text-primary space-y-6 2xl:flex 2xl:space-y-0 2xl:space-x-7">
        ...
        <AtomButton label="Отправить заявку" color="primary" mode="full" />
