...
<template>
  <UISafeAreaView>
    <div class="container pt-7.5 2xl:pt-6">
      ...
      <div class="mt-7.5">
        <MoleculeTabsContainer ref="tabsContainer" :tabs="['Новости', 'Видео-обзоры']"
          ...
          <template #1>
            <div>
              <div
                ...
                <NuxtLink v-for="item in data?.news" :key="item.title" class="inline-block"
                  ...
                  <div class="w-full max-w-[420px] mx-auto">
                    <div class="mx-auto h-full bg-background">
                      <img :src="src(item.thumbnail ? item.thumbnail : '')" class="h-[190px] w-full object-cover"
                        loading="lazy" />
          ...
          <template #2>
            <div>
              ...
              <div
                ...
                <button v-for="item in data?.video_news" :key="item.title" class="inline-block"
                  to="">
                  <div class="w-full max-w-[420px] mx-auto">
                    <div class="mx-auto h-full bg-background">
