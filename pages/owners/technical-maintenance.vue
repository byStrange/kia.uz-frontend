  ...
  <div>
    ...
    >
      ...
      <picture>
        <source
          :srcset="
            src('83410439-5208-44d2-bb4e-74771941e38f', {
              crop: '1440x864/0,0',
              preview: '1440x600',
            })
          "
      ...
      <UIContainer
        class="py-5 w-full absolute left-[--left] top-[--safe-area-padding-top] hidden 2xl:block z-20"
      >
      ...
      >
        <div
          class="text-white space-y-3 md:max-w-5h md:space-y-3 2xl:max-w-7.25h"
        >
          <h1 class="text-2xl md:text-4xl 2xl:text-7xl">
            Техническое обслуживание
          </h1>
          <p class="text-base md:text-base+ 2xl:text-lg">
            Мы хотим, чтобы вы получали максимум удовольствия от вождения вашего
            автомобиля Kia. Поддерживайте свой автомобиль в идеальном состоянии
            и снижайте эксплуатационные расходы.
          </p>
        </div>
        <AtomButton
          label="Онлайн-запись"
    ...
    <UIContainer
      class="py-16 space-y-7.5 md:bg-background md:space-y-8 2xl:py-1h 2xl:space-y-[70px]"
    >
      ...
      <div class="section-1-content-container">
        <div class="text-primary flex gap-x-9 md:py-3 md:gap-x-6 2xl:py-0">
          <UIServiceIcon />
          <div
            class="text-base+ border-b border-protection pb-3 flex-1 md:pb-0 md:border-none"
          >
            <b class="h-12.5 inline-block md:h-auto"
              >Мастера-технические специалисты Kia</b
            >
          </div>
        </div>

        <div
          class="text-primary flex gap-x-9 md:py-3 md:gap-x-6 md:ml-2.5 2xl:ml-0 2xl:py-0"
        >
          <UISparePartsIcon />
          <div
            class="text-base+ border-b border-protection pb-3 flex-1 md:pb-0 md:border-none"
          >
            <b class="h-12.5 inline-block md:h-auto">Оригинальные запчасти</b>
          </div>
        </div>

        <div
          class="text-primary flex gap-x-9 md:py-3 md:gap-x-6 md:mt-2.5 2xl:mt-0 2xl:py-0"
        >
          <UIEducationalAndMedicalInfoIcon />
          <div
            class="text-base+ border-b border-protection pb-3 flex-1 md:pb-0 md:border-none"
          >
            <b class="h-12.5 inline-block md:h-auto">Диагностика автомобиля</b>
          </div>
        </div>

        <div
          class="text-primary flex gap-x-9 md:py-3 md:gap-x-6 md:ml-2.5 md:mt-2.5 2xl:m-0 2xl:py-0"
        >
          <UIGuaranteeIcon />
          <div
            class="text-base+ border-b border-protection pb-3 flex-1 md:pb-0 md:border-none"
          >
            <b class="h-12.5 inline-block md:h-auto"
              >Гарантия качества и оптимальной цены</b
            >
          </div>
        </div>
      </div>
    ...
    <UIContainer class="py-10 space-y-12.5 md:py-[70px] 2xl:py-1h 2xl:space-y-7.5">
      <div>
        <h1 class="text-2xl 2xl:text-3xl">Регламентное ТО</h1>
