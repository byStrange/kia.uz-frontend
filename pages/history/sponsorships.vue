  ...
  <UISafeAreaView>
    ...
    <div class="pt-12">
      ...
      <UISplitLayout title="Australian Open" :classNames="{
        ...
        <template #right>
          <picture>
            <img :src="src('546abb9a-ea37-45b2-a8e5-388b26337b76')" />
          </picture>
        </template>
      </UISplitLayout>
      ...
      <UISplitLayout title="FIFA" :classNames="{
        ...
        <template #right>
          <picture>
            <img :src="src('ce002b39-e0fe-48e7-a4fa-cf9622787013')" />
          </picture>
        </template>
      </UISplitLayout>
      ...
      <UISplitLayout title="Leagues of Legends Европейский чемпионат" :classNames="{
        ...
        <template #right>
          <picture>
            <img :src="src('b68ff466-f88f-4b61-a970-f1f6229ba8b8')" />
          </picture>
        </template>
      </UISplitLayout>
      <div class="container">
        <div class="divider w-full h-1px bg-protection my-12 md:my-15 2xl:my-16"></div>
      </div>
    </div>
