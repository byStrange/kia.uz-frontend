...
import { useBriefSectionService } from '@/services/briefSectionService';
...
const { sections, is } = useBriefSectionService();

const slides = useTemplateRef<InstanceType<typeof SlideView>[]>('slidesRef');
const tabs = useTemplateRef<InstanceType<typeof TabsContainer>[]>('tabsRef');
