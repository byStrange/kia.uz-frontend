...
import FilterIcon from '@/components/icons/20x20/FilterIcon.vue';
      ...
      <div>
        ...
        >
          <div>
            ...
            >
              379 900 000 сум <InfoIcon class="text-disabled" />
            </p>
          </div>
          <div class="gap-4 hidden 2xl:flex">
            <Button label="Свяжитесь с нами" color="secondary" mode="full" />
            <Button label="Скачать прайс-лист" mode="full" />
          </div>
        </div>
      </div>
